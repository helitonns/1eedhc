...
public class IndexMB implements Serializable {
    ...
    public String salvarOuvinte() {
        try {
            ...
            System.out.println("1: " + quantidadeDeOuvintesPresenciais + 1);
            System.out.println("2: " + evento.getNumeroDeVagas());
            
            if ((quantidadeDeOuvintesPresenciais + 1) > evento.getNumeroDeVagas()) {
                FacesUtils.addWarnMessageFlashScoped("O número de vagas presenciais já foram preenchidas.");
                return "";
            } else {
